...
4. **Applied Lean** — applications of Lean and formal verification beyond mathematics, currently to smart contracts.
...
## 2 · Modeling mathematical reasoning — math-reasoning-tools
...
## 3 · Tooling for the AI-does-math regime
...
flowchart TB
    ...
    SCV["sc-verification<br/>4 · Applied Lean"]
...
| [tactics_generation](https://github.com/Sfgangloff/tactics_generation) | 3 Tooling — encode mental processes | Lean / Python | 2×2 study + encoding mathematicians' moves in Lean | Study complete |
| [theorem-prover](https://github.com/Sfgangloff/theorem-prover) | 3 Tooling — toy prover | Python / Lean | Toy RL pipeline to see what modern theorem provers look like | Learning project |
...
| [sc-verification](https://github.com/Sfgangloff/sc-verification) | 4 Applied Lean | Solidity | Formal verification of smart contracts | Experimental |
